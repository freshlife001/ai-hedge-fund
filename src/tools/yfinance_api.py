...
def search_line_items(
    ...
    try:
        ...
        for i, date in enumerate(sorted_dates):
            ...
            line_item_data["earnings_per_share"] = None
            line_item_data["current_assets"] = None
            line_item_data["current_liabilities"] = None
            line_item_data["book_value_per_share"] = None
            line_item_data["free_cash_flow"] = None
            line_item_data["operating_margin"] = None
            line_item_data["debt_to_equity"] = None
            line_item_data["gross_margin"] = None
            line_item_data["ebit"] = None
            line_item_data["ebitda"] = None
